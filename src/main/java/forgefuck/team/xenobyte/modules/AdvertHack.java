...
public class AdvertHack extends CheatModule {
    ...
    @Override public String moduleDesc() {
        return lang.get("Replacing all advertising images in MalisisAdvert with an image from the link");
    }
        ...
        return new Panel(
            new Button("AdvertUrl") {
                @Override public void onLeftClick() {
                    new UserInput(lang.get("Links"), urls, InputType.SINGLE_STRING).showFrame();
                }
            }
        );
    }
