...
public class EIOTeleport extends CheatModule {
    ...
    @Override public String moduleDesc() {
        return lang.get("Teleports an object with the specified settings");
    }
        ...
        return new Panel(
            new Button("Coords") {
                @Override public void onLeftClick() {
                    new UserInput(lang.get("Coords"), coords, InputType.COORDS).showFrame();
                }
                @Override public String elementDesc() {
                    return lang.get("Specified x y z");
                }
            },
            new Button("ItemTeleport", items) {
                ...
                @Override public String elementDesc() {
                    return lang.get("Teleporting items instead of the player");
                }
            },
            new Button("OnView", onView) {
                ...
                @Override public String elementDesc() {
                    return lang.get("Teleport by sight or coordinates");
                }
            },
            new Button("Intercept", intercept) {
                ...
                @Override public String elementDesc() {
                    return lang.get("Interception of the chat command") + " /tp nick x y z";
                }
            }
        );
    }
