...
public class TextRadar extends CheatModule {
    ...
    @Override public void onTick(boolean inGame) {
        if (inGame) {
            ...
            infoMessage(empty ? lang.get("nobody") : out.toString(), empty ? WidgetMode.SUCCESS : WidgetMode.FAIL);
        }
    }
    
    @Override public String moduleDesc() {
        return lang.get("Displays the nearest players and the distance to them on the info panel");
    }
